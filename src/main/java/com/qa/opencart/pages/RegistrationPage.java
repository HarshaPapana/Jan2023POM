...
public class RegistrationPage {
	...
	//(//label[@class='radio-inline'])[2]/input
	...
	private By userRegSuccMesg = By.cssSelector("div#content h1");
	...
	public String registerUser(String firstName, String lastName, String email, String telephone, String password, String subscribe) {
		...
		String userRegSuccessMesg = eleUtil.waitForElementVisible(userRegSuccMesg, AppConstants.MEDIUM_DEFAULT_WAIT).getText();
